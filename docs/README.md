# Dim Sum Atlas documentation

This documentation index covers the shipped surfaces. The catalog is intentionally explicit about which story text is fictional catalog lore.
...
- [Installer and updater proof inventory](features/installer-update-proof.md)
